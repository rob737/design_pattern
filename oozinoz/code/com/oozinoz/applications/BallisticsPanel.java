...
*/
/**
 * Plot a ballistics function. This class is refactored
 * from BallisticsPanel_2 to rely on a Tpeak object from
 * the business domain.
 * 
 * @author Steven J. Metsker
 */
public class BallisticsPanel
 ...
 *             of peak burn area.
 * @param tPeak an observable model of the time when burn
 *              area peaks
 */
public BallisticsPanel(
