 ...
 */
/**
 * This planner predicts when a star press will become
 * available. A complete implementation would probably
 * consider many variables that affect a star press.
 * 
...
/**
 * Return a datetime when the star press that this 
 * planner represents will next become available. 
 *
 * @return Date when the star press that this 
