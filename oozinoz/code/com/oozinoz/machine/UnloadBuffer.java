...
{
/**
 * Return a basic planner, since unload buffers are pretty
 * predictable.
 * 
...
/**
 * Create a buffer with the given id and with the supplied 
 * parent machine.
 *
...
/**
 * Create a buffer with the given id and with access to the
 ...
 *                 relation to bins
 */
protected UnloadBuffer(int id, Mediator mediator)
{
	this(id, mediator, null);
}

/**
 * Create a buffer with the given id, with access to the
