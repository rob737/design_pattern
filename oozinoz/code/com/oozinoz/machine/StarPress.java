...
/**
 * Create a press with the given id and with the supplied 
 * parent machine.
 *
...
/**
 * Create a press with the given id and with access to the
 ...
 *                 relation to bins
 */
protected StarPress(int id, Mediator mediator)
{
	this(id, mediator, null);
}

/**
 * Create a press with the given id, with access to the
